...
const meraaz = {
  name: "Mohd Meraaz",
  location: "India 🇮🇳",
  role: "Java Full Stack Trainee | Software Engineer",
  education: "B.Tech in Computer Science (AI & ML Specialization)",

  dsa: {
    leetcode:      "Active Problem Solver | 50, 100 & 200 Day Badges",
    hackerrank:    "Recognized for Coding Excellence",
    codechef:      "Competitive Programmer",
    geeksforgeeks: "Active Contributor",
  },

  skills: ["Java Full Stack", "Android Development", "AI & ML", "DSA"],
  currentlyLearning: ["Spring Boot", "Advanced ML", "System Design"],
  certifications: ["Machine Learning", "Python", "SQL", "Java", "Android Dev"],
  funFact: "I turn ☕ coffee into 🤖 AI models and 📱 Android apps!"
};
```

---

## 📊 DSA Competitive Profiles

<div align="center">

| Platform | Profile | Achievement |
|:---:|:---:|:---:|
| 🟡 **LeetCode** | [MdMeraaz08](https://leetcode.com/u/MdMeraaz08/) | 50, 100, 200 Day Badges · 365 Day Streak |
| 🟣 **HackerRank** | [meraaz0809](https://www.hackerrank.com/profile/meraaz0809) | Recognized for Coding Excellence |
| 🟤 **CodeChef** | [md_meraaz08](https://www.codechef.com/users/md_meraaz08) | Competitive Programmer |
| 🟢 **GeeksForGeeks** | [meraaz086l](https://www.geeksforgeeks.org/profile/meraaz086l) | Active Contributor |

</div>

---

## 🏆 LeetCode Badges & Milestones

<div align="center">

**🎯 Milestone Achievements**

<img src="https://assets.leetcode.com/static_assets/marketing/2024-50.gif" width="65" title="50 Days Badge 2024"/>
<img src="https://assets.leetcode.com/static_assets/marketing/2024-100-new.gif" width="65" title="100 Days Badge 2024"/>
<img src="https://assets.leetcode.com/static_assets/marketing/2024-200.gif" width="65" title="200 Days Badge 2024"/>
<img src="https://assets.leetcode.com/static_assets/marketing/365_new.gif" width="65" title="365 Days Streak!"/>
...
### 🔹 BrightPath
**AI-powered e-learning platform** for personalized learning roadmaps & community referrals.

### 🔹 To-Do List App
Built using **Kotlin & Jetpack Compose** with RecyclerView support.

### 🔹 Hospital Management System
**PHP & MySQL** web system for automating hospital workflows.

### 🔹 DSA Toolkit
**C++ terminal-based toolkit** implementing advanced data structure operations.
